...
ARG IPXE_BINARIES_IMAGE=quay.io/metal3-io/ipxe-binaries@sha256:702959a23760af403bb358d1b8b10dd2eff707a3fbc372a88231665a8f29dade # iPXE commit d0ea2b1bb8f78b219f74424d435b92ff8aa0ea8d

# Python tooling versions - update these regularly
ARG PIP_VERSION=26.2.1
ARG SETUPTOOLS_VERSION=84.0.0

ARG OPENSTACK_REQUIREMENTS_SOURCE=e7f5b22a07aa8ec5ed47d92507cd16a1d80b99e3 # master
...
ENV UPPER_CONSTRAINTS_FILE=${UPPER_CONSTRAINTS_FILE} \
    OPENSTACK_REQUIREMENTS_SOURCE=${OPENSTACK_REQUIREMENTS_SOURCE} \
...
ARG UPPER_CONSTRAINTS_FILE=upper-constraints.txt
ARG IRONIC_SOURCE=059613bb56a847ec0211c1e90a4e23c2b9cb4ad2 # master
ARG OPENSTACK_REQUIREMENTS_SOURCE
ARG SUSHY_SOURCE
